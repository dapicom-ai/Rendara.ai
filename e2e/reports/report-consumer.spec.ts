/**
 * DEPRECATED — Report Consumer Tests
 *
 * The /r/[uuid] public report consumer route has been removed from Rendara v2.
...
test("TC-RPT-010c: Consumer shows 'Report not found' for invalid UUID", async ({
  ...
  // "Report not found" should be visible (use heading role to avoid strict-mode multi-match)
