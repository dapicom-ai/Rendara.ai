/**
 * DEPRECATED — Report Lifecycle Tests
 *
 * The /reports route and report lifecycle have been removed from Rendara v2.
 * All tests below are disabled. See e2e/report.spec.ts for the
 * regression guard that confirms these routes return 404.
 *
